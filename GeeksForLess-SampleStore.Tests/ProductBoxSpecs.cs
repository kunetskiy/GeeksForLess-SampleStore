...
namespace GeeksForLess_SampleStore.Tests
{
    public class ProductBoxSpecs
    {
        ...
        {
            ProductBox pb1 = new ProductBox(TempProduct1, 5);
            ProductBox pb2 = new ProductBox(TempProduct1, 5);
        ...
        {
            ProductBox pb1 = new ProductBox(TempProduct1, 6);
            ProductBox pb2 = new ProductBox(TempProduct1, 5);
        ...
        {
            ProductBox pb1 = new ProductBox(TempProduct1, 5);
            ProductBox pb2 = new ProductBox(TempProduct2, 5);
        ...
        {
            ProductBox pb1 = new ProductBox(TempProduct1, 1);
